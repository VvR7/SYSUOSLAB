...
global asm_out_port_word
global asm_in_port_word
extern c_time_interrupt_handler
extern system_call_table
extern c_page_interrupt_handler
...
asm_page_fault_handler:
    ; 错误码已经在栈顶了
    pushad
    push dword [esp + 32]  ; 将错误码作为参数传递 (pushad压入了8个寄存器=32字节)
    call c_page_interrupt_handler
    add esp, 4            ; 清理参数
    popad
    add esp, 4            ; 清理错误码
    iret

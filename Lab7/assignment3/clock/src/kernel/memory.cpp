...
void MemoryManager::initialize()
{
    ...
    //int swapPhysicalBitMapStart=kernelVirtualBitMapStart+ceil(swapPages,8);
...
{
    printf("releasePhysicalPages: %d\n",(paddr-kernelPhysicalStartAddress)/PAGE_SIZE);
    if (type == AddressPoolType::KERNEL)
    {
